...
for iter = 1:params.maxIter
    switch params.solver
        case 'fusion'
            [tmp_controller, tmp_sol, diagnostics] = datadriven.utils.solveddMOSEK(system,obj,cons,params,sol);
        otherwise
            [tmp_controller, tmp_sol, diagnostics] = datadriven.utils.solveddYALMIP(system,obj,cons,params,sol);     
    end
...
%% Returns
controller = datadriven.utils.toTF(system.controller);
